...
/** @typedef {"withdraw" | "deposit" | "balance_transfer" | "small_change_cards" | "bills" | "other" | "cash_addition" | "liquidation" | "external"} OperationType */
...
export function operationTypesForSourceKind(kind) {
  const common = [OPERATION_TYPE.LIQUIDATION, OPERATION_TYPE.EXTERNAL];
